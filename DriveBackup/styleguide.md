This Style Guide is based on [twitter-archive/commons/java/styleguide](https://github.com/twitter-archive/commons/blob/master/src/java/com/twitter/common/styleguide.md)
