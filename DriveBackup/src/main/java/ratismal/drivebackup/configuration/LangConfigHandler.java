...
public final class LangConfigHandler {
    ...
    private static @NotNull CommentedConfigurationNode getDefaults() throws SerializationException {
        ...
        defaults.node("brief-backup-list-help").set("Want to back up something else? See\n"
                                                    + "<gold><click:open_url:http://bit.ly/3xoHRAs>http://bit.ly/3xoHRAs</click></gold>");
        ...
        String playerJoinUpdateAvailable = "An update is available, get it here: <gold><click:open_url:http://bit.ly/2M14uVD>http://bit.ly/2M14uVD</click></gold>\n"
