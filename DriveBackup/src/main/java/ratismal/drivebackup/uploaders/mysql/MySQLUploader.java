...
public class MySQLUploader {
    ...
    public void downloadDatabase(String name, String type, List<String> blacklist) {
        ...
        try {
            ...
            try (Connection connection = DriverManager.getConnection(connectionUrl, username, password)) {
                ...
                File outputPath = new java.io.File("external-backups" + File.separator + type);
     ...
     * @throws SQLException exception
     */
    private void getInsertStatements(OutputStreamWriter sql, String name, List<String> blacklist) throws SQLException, IOException {
        sql.append("--");
